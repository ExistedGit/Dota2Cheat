...
namespace Signatures {
	...
	void InitSignatures() {
		...
		ParseCombo("83 FA FF 0F 84 ? ? ? ? 48 89 6C 24 18 56 48 83 EC 30 48 63 81 80 00 00 00", funcAddr, funcAddrMask);
		DestroyParticle = (DestroyParticleFn)PatternScanExModule(CurProcHandle, CurProcId, L"client.dll", funcAddr, funcAddrMask);
