...
public:
    ...
    virtual bool SendNetMessage( int splitScreenSlot, void *handle, void const * something,  NetChannelBufType_t type ) = 0; // This function is trash and never gets called
