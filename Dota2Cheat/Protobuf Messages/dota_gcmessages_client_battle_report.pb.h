...
class CMsgBattleReport_GameList final :
 ...
 public:
  ...
  public:
  void clear_game();
  ::CMsgBattleReport_Game* mutable_game(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::CMsgBattleReport_Game >*
      mutable_game();
  private:
  const ::CMsgBattleReport_Game& _internal_game(int index) const;
  ::CMsgBattleReport_Game* _internal_add_game();
  public:
  const ::CMsgBattleReport_Game& game(int index) const;
  ::CMsgBattleReport_Game* add_game();
 ...
 private:
  ...
  typedef void DestructorSkippable_;
  struct Impl_ {
    ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::CMsgBattleReport_Game > game_;
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  };
  union { Impl_ _impl_; };
  friend struct ::TableStruct_dota_5fgcmessages_5fclient_5fbattle_5freport_2eproto;
...
// repeated .CMsgBattleReport_Game game = 1;
inline int CMsgBattleReport_GameList::_internal_game_size() const {
  return _impl_.game_.size();
}
inline int CMsgBattleReport_GameList::game_size() const {
  return _internal_game_size();
}
inline void CMsgBattleReport_GameList::clear_game() {
  _impl_.game_.Clear();
}
inline ::CMsgBattleReport_Game* CMsgBattleReport_GameList::mutable_game(int index) {
  // @@protoc_insertion_point(field_mutable:CMsgBattleReport_GameList.game)
  return _impl_.game_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::CMsgBattleReport_Game >*
CMsgBattleReport_GameList::mutable_game() {
  // @@protoc_insertion_point(field_mutable_list:CMsgBattleReport_GameList.game)
  return &_impl_.game_;
}
inline const ::CMsgBattleReport_Game& CMsgBattleReport_GameList::_internal_game(int index) const {
  return _impl_.game_.Get(index);
}
inline const ::CMsgBattleReport_Game& CMsgBattleReport_GameList::game(int index) const {
  // @@protoc_insertion_point(field_get:CMsgBattleReport_GameList.game)
  return _internal_game(index);
}
inline ::CMsgBattleReport_Game* CMsgBattleReport_GameList::_internal_add_game() {
  return _impl_.game_.Add();
}
inline ::CMsgBattleReport_Game* CMsgBattleReport_GameList::add_game() {
  ::CMsgBattleReport_Game* _add = _internal_add_game();
  // @@protoc_insertion_point(field_add:CMsgBattleReport_GameList.game)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::CMsgBattleReport_Game >&
CMsgBattleReport_GameList::game() const {
  // @@protoc_insertion_point(field_list:CMsgBattleReport_GameList.game)
  return _impl_.game_;
}
