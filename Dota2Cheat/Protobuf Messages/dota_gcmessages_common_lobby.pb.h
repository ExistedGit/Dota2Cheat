...
class CMsgLobbyEventPoints_PingWheelMessageRange;
struct CMsgLobbyEventPoints_PingWheelMessageRangeDefaultTypeInternal;
extern CMsgLobbyEventPoints_PingWheelMessageRangeDefaultTypeInternal _CMsgLobbyEventPoints_PingWheelMessageRange_default_instance_;
...
template<> ::CMsgLobbyEventPoints_ChatWheelMessageRange* Arena::CreateMaybeMessage<::CMsgLobbyEventPoints_ChatWheelMessageRange>(Arena*);
...
template<> ::CMsgLobbyEventPoints_PingWheelMessageRange* Arena::CreateMaybeMessage<::CMsgLobbyEventPoints_PingWheelMessageRange>(Arena*);
...
class CMsgLobbyEventPoints_ChatWheelMessageRange final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:CMsgLobbyEventPoints.ChatWheelMessageRange) */ {
 public:
  inline CMsgLobbyEventPoints_ChatWheelMessageRange() : CMsgLobbyEventPoints_ChatWheelMessageRange(nullptr) {}
  ~CMsgLobbyEventPoints_ChatWheelMessageRange() override;
  explicit PROTOBUF_CONSTEXPR CMsgLobbyEventPoints_ChatWheelMessageRange(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  inline void Swap(CMsgLobbyEventPoints_ChatWheelMessageRange* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(CMsgLobbyEventPoints_ChatWheelMessageRange* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  CMsgLobbyEventPoints_ChatWheelMessageRange* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  void MergeFrom( const CMsgLobbyEventPoints_ChatWheelMessageRange& from) {
    CMsgLobbyEventPoints_ChatWheelMessageRange::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "CMsgLobbyEventPoints.ChatWheelMessageRange";
  }
  protected:
  explicit CMsgLobbyEventPoints_ChatWheelMessageRange(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  // @@protoc_insertion_point(class_scope:CMsgLobbyEventPoints.ChatWheelMessageRange)
 private:
  class _Internal;
...
class CMsgLobbyEventPoints_PingWheelMessageRange final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:CMsgLobbyEventPoints.PingWheelMessageRange) */ {
 public:
  inline CMsgLobbyEventPoints_PingWheelMessageRange() : CMsgLobbyEventPoints_PingWheelMessageRange(nullptr) {}
  ~CMsgLobbyEventPoints_PingWheelMessageRange() override;
  explicit PROTOBUF_CONSTEXPR CMsgLobbyEventPoints_PingWheelMessageRange(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  CMsgLobbyEventPoints_PingWheelMessageRange(const CMsgLobbyEventPoints_PingWheelMessageRange& from);
  CMsgLobbyEventPoints_PingWheelMessageRange(CMsgLobbyEventPoints_PingWheelMessageRange&& from) noexcept
    : CMsgLobbyEventPoints_PingWheelMessageRange() {
    *this = ::std::move(from);
  }

  inline CMsgLobbyEventPoints_PingWheelMessageRange& operator=(const CMsgLobbyEventPoints_PingWheelMessageRange& from) {
    CopyFrom(from);
    return *this;
  }
  inline CMsgLobbyEventPoints_PingWheelMessageRange& operator=(CMsgLobbyEventPoints_PingWheelMessageRange&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const CMsgLobbyEventPoints_PingWheelMessageRange& default_instance() {
    return *internal_default_instance();
  }
  static inline const CMsgLobbyEventPoints_PingWheelMessageRange* internal_default_instance() {
    return reinterpret_cast<const CMsgLobbyEventPoints_PingWheelMessageRange*>(
               &_CMsgLobbyEventPoints_PingWheelMessageRange_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    4;

  friend void swap(CMsgLobbyEventPoints_PingWheelMessageRange& a, CMsgLobbyEventPoints_PingWheelMessageRange& b) {
    a.Swap(&b);
  }
  inline void Swap(CMsgLobbyEventPoints_PingWheelMessageRange* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(CMsgLobbyEventPoints_PingWheelMessageRange* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  CMsgLobbyEventPoints_PingWheelMessageRange* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<CMsgLobbyEventPoints_PingWheelMessageRange>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const CMsgLobbyEventPoints_PingWheelMessageRange& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const CMsgLobbyEventPoints_PingWheelMessageRange& from) {
    CMsgLobbyEventPoints_PingWheelMessageRange::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(CMsgLobbyEventPoints_PingWheelMessageRange* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "CMsgLobbyEventPoints.PingWheelMessageRange";
  }
  protected:
  explicit CMsgLobbyEventPoints_PingWheelMessageRange(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  // @@protoc_insertion_point(class_scope:CMsgLobbyEventPoints.PingWheelMessageRange)
 private:
  class _Internal;
...
class CMsgLobbyEventPoints_AccountPoints final :
 ...
 public:
  ...
  enum : int {
    kUnlockedChatWheelMessageRangesFieldNumber = 13,
    kUnlockedPingWheelMessageRangesFieldNumber = 22,
    kEventGameCustomActionsFieldNumber = 25,
    kNetworkedEventActionsFieldNumber = 30,
    kPeriodicResourcesFieldNumber = 31,
    kPlusSubscriptionDataFieldNumber = 16,
  ...
  ::CMsgLobbyEventPoints_ChatWheelMessageRange* mutable_unlocked_chat_wheel_message_ranges(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::CMsgLobbyEventPoints_ChatWheelMessageRange >*
      mutable_unlocked_chat_wheel_message_ranges();
  private:
  const ::CMsgLobbyEventPoints_ChatWheelMessageRange& _internal_unlocked_chat_wheel_message_ranges(int index) const;
  ::CMsgLobbyEventPoints_ChatWheelMessageRange* _internal_add_unlocked_chat_wheel_message_ranges();
  public:
  const ::CMsgLobbyEventPoints_ChatWheelMessageRange& unlocked_chat_wheel_message_ranges(int index) const;
  ::CMsgLobbyEventPoints_ChatWheelMessageRange* add_unlocked_chat_wheel_message_ranges();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::CMsgLobbyEventPoints_ChatWheelMessageRange >&
  ...
  ::CMsgLobbyEventPoints_PingWheelMessageRange* mutable_unlocked_ping_wheel_message_ranges(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::CMsgLobbyEventPoints_PingWheelMessageRange >*
      mutable_unlocked_ping_wheel_message_ranges();
  private:
  const ::CMsgLobbyEventPoints_PingWheelMessageRange& _internal_unlocked_ping_wheel_message_ranges(int index) const;
  ::CMsgLobbyEventPoints_PingWheelMessageRange* _internal_add_unlocked_ping_wheel_message_ranges();
  public:
  const ::CMsgLobbyEventPoints_PingWheelMessageRange& unlocked_ping_wheel_message_ranges(int index) const;
  ::CMsgLobbyEventPoints_PingWheelMessageRange* add_unlocked_ping_wheel_message_ranges();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::CMsgLobbyEventPoints_PingWheelMessageRange >&
  ...
  private:
  bool _internal_has_plus_subscription_data() const;
  public:
  void clear_plus_subscription_data();
  const ::CMsgLobbyPlayerPlusSubscriptionData& plus_subscription_data() const;
  PROTOBUF_NODISCARD ::CMsgLobbyPlayerPlusSubscriptionData* release_plus_subscription_data();
  ::CMsgLobbyPlayerPlusSubscriptionData* mutable_plus_subscription_data();
  void set_allocated_plus_subscription_data(::CMsgLobbyPlayerPlusSubscriptionData* plus_subscription_data);
  private:
  const ::CMsgLobbyPlayerPlusSubscriptionData& _internal_plus_subscription_data() const;
  ::CMsgLobbyPlayerPlusSubscriptionData* _internal_mutable_plus_subscription_data();
  public:
  void unsafe_arena_set_allocated_plus_subscription_data(
      ::CMsgLobbyPlayerPlusSubscriptionData* plus_subscription_data);
  ::CMsgLobbyPlayerPlusSubscriptionData* unsafe_arena_release_plus_subscription_data();
 ...
 private:
  ...
  struct Impl_ {
    ::PROTOBUF_NAMESPACE_ID::internal::HasBits<1> _has_bits_;
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
    ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::CMsgLobbyEventPoints_ChatWheelMessageRange > unlocked_chat_wheel_message_ranges_;
    ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::CMsgLobbyEventPoints_PingWheelMessageRange > unlocked_ping_wheel_message_ranges_;
    ...
    ::CMsgLobbyPlayerPlusSubscriptionData* plus_subscription_data_;
...
class CMsgLobbyEventPoints final :
 ...
 public:
  ...
  typedef CMsgLobbyEventPoints_PingWheelMessageRange PingWheelMessageRange;
...
class CSODOTALobby final :
 ...
 public:
  ...
  uint32_t lobby_mvp_account_id() const;
  void set_lobby_mvp_account_id(uint32_t value);
  private:
  uint32_t _internal_lobby_mvp_account_id() const;
  void _internal_set_lobby_mvp_account_id(uint32_t value);
  public:
 ...
 private:
  ...
  struct Impl_ {
    ...
    int pause_setting_;
    uint32_t lobby_mvp_account_id_;
...
// optional uint32 message_id_start = 1;
inline bool CMsgLobbyEventPoints_ChatWheelMessageRange::_internal_has_message_id_start() const {
  bool value = (_impl_._has_bits_[0] & 0x00000001u) != 0;
  return value;
}
...
inline void CMsgLobbyEventPoints_ChatWheelMessageRange::clear_message_id_start() {
  _impl_.message_id_start_ = 0u;
  _impl_._has_bits_[0] &= ~0x00000001u;
}
inline uint32_t CMsgLobbyEventPoints_ChatWheelMessageRange::_internal_message_id_start() const {
  return _impl_.message_id_start_;
}
inline uint32_t CMsgLobbyEventPoints_ChatWheelMessageRange::message_id_start() const {
  // @@protoc_insertion_point(field_get:CMsgLobbyEventPoints.ChatWheelMessageRange.message_id_start)
  return _internal_message_id_start();
}
inline void CMsgLobbyEventPoints_ChatWheelMessageRange::_internal_set_message_id_start(uint32_t value) {
  _impl_._has_bits_[0] |= 0x00000001u;
  _impl_.message_id_start_ = value;
}
inline void CMsgLobbyEventPoints_ChatWheelMessageRange::set_message_id_start(uint32_t value) {
  _internal_set_message_id_start(value);
  // @@protoc_insertion_point(field_set:CMsgLobbyEventPoints.ChatWheelMessageRange.message_id_start)
}

// optional uint32 message_id_end = 2;
inline bool CMsgLobbyEventPoints_ChatWheelMessageRange::_internal_has_message_id_end() const {
  bool value = (_impl_._has_bits_[0] & 0x00000002u) != 0;
  return value;
}
...
inline void CMsgLobbyEventPoints_ChatWheelMessageRange::clear_message_id_end() {
  _impl_.message_id_end_ = 0u;
  _impl_._has_bits_[0] &= ~0x00000002u;
}
inline uint32_t CMsgLobbyEventPoints_ChatWheelMessageRange::_internal_message_id_end() const {
  return _impl_.message_id_end_;
}
inline uint32_t CMsgLobbyEventPoints_ChatWheelMessageRange::message_id_end() const {
  // @@protoc_insertion_point(field_get:CMsgLobbyEventPoints.ChatWheelMessageRange.message_id_end)
  return _internal_message_id_end();
}
inline void CMsgLobbyEventPoints_ChatWheelMessageRange::_internal_set_message_id_end(uint32_t value) {
  _impl_._has_bits_[0] |= 0x00000002u;
  _impl_.message_id_end_ = value;
}
inline void CMsgLobbyEventPoints_ChatWheelMessageRange::set_message_id_end(uint32_t value) {
  _internal_set_message_id_end(value);
  // @@protoc_insertion_point(field_set:CMsgLobbyEventPoints.ChatWheelMessageRange.message_id_end)
}
...
// optional uint32 message_id_start = 1;
inline bool CMsgLobbyEventPoints_PingWheelMessageRange::_internal_has_message_id_start() const {
  bool value = (_impl_._has_bits_[0] & 0x00000001u) != 0;
  return value;
}
inline bool CMsgLobbyEventPoints_PingWheelMessageRange::has_message_id_start() const {
  return _internal_has_message_id_start();
}
inline void CMsgLobbyEventPoints_PingWheelMessageRange::clear_message_id_start() {
  _impl_.message_id_start_ = 0u;
  _impl_._has_bits_[0] &= ~0x00000001u;
}
inline uint32_t CMsgLobbyEventPoints_PingWheelMessageRange::_internal_message_id_start() const {
  return _impl_.message_id_start_;
}
inline uint32_t CMsgLobbyEventPoints_PingWheelMessageRange::message_id_start() const {
  // @@protoc_insertion_point(field_get:CMsgLobbyEventPoints.PingWheelMessageRange.message_id_start)
  return _internal_message_id_start();
}
inline void CMsgLobbyEventPoints_PingWheelMessageRange::_internal_set_message_id_start(uint32_t value) {
  _impl_._has_bits_[0] |= 0x00000001u;
  _impl_.message_id_start_ = value;
}
inline void CMsgLobbyEventPoints_PingWheelMessageRange::set_message_id_start(uint32_t value) {
  _internal_set_message_id_start(value);
  // @@protoc_insertion_point(field_set:CMsgLobbyEventPoints.PingWheelMessageRange.message_id_start)
}

// optional uint32 message_id_end = 2;
inline bool CMsgLobbyEventPoints_PingWheelMessageRange::_internal_has_message_id_end() const {
  bool value = (_impl_._has_bits_[0] & 0x00000002u) != 0;
  return value;
}
inline bool CMsgLobbyEventPoints_PingWheelMessageRange::has_message_id_end() const {
  return _internal_has_message_id_end();
}
inline void CMsgLobbyEventPoints_PingWheelMessageRange::clear_message_id_end() {
  _impl_.message_id_end_ = 0u;
  _impl_._has_bits_[0] &= ~0x00000002u;
}
inline uint32_t CMsgLobbyEventPoints_PingWheelMessageRange::_internal_message_id_end() const {
  return _impl_.message_id_end_;
}
inline uint32_t CMsgLobbyEventPoints_PingWheelMessageRange::message_id_end() const {
  // @@protoc_insertion_point(field_get:CMsgLobbyEventPoints.PingWheelMessageRange.message_id_end)
  return _internal_message_id_end();
}
inline void CMsgLobbyEventPoints_PingWheelMessageRange::_internal_set_message_id_end(uint32_t value) {
  _impl_._has_bits_[0] |= 0x00000002u;
  _impl_.message_id_end_ = value;
}
inline void CMsgLobbyEventPoints_PingWheelMessageRange::set_message_id_end(uint32_t value) {
  _internal_set_message_id_end(value);
  // @@protoc_insertion_point(field_set:CMsgLobbyEventPoints.PingWheelMessageRange.message_id_end)
}
...
// repeated .CMsgLobbyEventPoints.ChatWheelMessageRange unlocked_chat_wheel_message_ranges = 13;
inline int CMsgLobbyEventPoints_AccountPoints::_internal_unlocked_chat_wheel_message_ranges_size() const {
...
inline ::CMsgLobbyEventPoints_ChatWheelMessageRange* CMsgLobbyEventPoints_AccountPoints::mutable_unlocked_chat_wheel_message_ranges(int index) {
  // @@protoc_insertion_point(field_mutable:CMsgLobbyEventPoints.AccountPoints.unlocked_chat_wheel_message_ranges)
  return _impl_.unlocked_chat_wheel_message_ranges_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::CMsgLobbyEventPoints_ChatWheelMessageRange >*
CMsgLobbyEventPoints_AccountPoints::mutable_unlocked_chat_wheel_message_ranges() {
  // @@protoc_insertion_point(field_mutable_list:CMsgLobbyEventPoints.AccountPoints.unlocked_chat_wheel_message_ranges)
  return &_impl_.unlocked_chat_wheel_message_ranges_;
}
inline const ::CMsgLobbyEventPoints_ChatWheelMessageRange& CMsgLobbyEventPoints_AccountPoints::_internal_unlocked_chat_wheel_message_ranges(int index) const {
  return _impl_.unlocked_chat_wheel_message_ranges_.Get(index);
}
inline const ::CMsgLobbyEventPoints_ChatWheelMessageRange& CMsgLobbyEventPoints_AccountPoints::unlocked_chat_wheel_message_ranges(int index) const {
  // @@protoc_insertion_point(field_get:CMsgLobbyEventPoints.AccountPoints.unlocked_chat_wheel_message_ranges)
  return _internal_unlocked_chat_wheel_message_ranges(index);
}
inline ::CMsgLobbyEventPoints_ChatWheelMessageRange* CMsgLobbyEventPoints_AccountPoints::_internal_add_unlocked_chat_wheel_message_ranges() {
  return _impl_.unlocked_chat_wheel_message_ranges_.Add();
}
inline ::CMsgLobbyEventPoints_ChatWheelMessageRange* CMsgLobbyEventPoints_AccountPoints::add_unlocked_chat_wheel_message_ranges() {
  ::CMsgLobbyEventPoints_ChatWheelMessageRange* _add = _internal_add_unlocked_chat_wheel_message_ranges();
  // @@protoc_insertion_point(field_add:CMsgLobbyEventPoints.AccountPoints.unlocked_chat_wheel_message_ranges)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::CMsgLobbyEventPoints_ChatWheelMessageRange >&
CMsgLobbyEventPoints_AccountPoints::unlocked_chat_wheel_message_ranges() const {
  // @@protoc_insertion_point(field_list:CMsgLobbyEventPoints.AccountPoints.unlocked_chat_wheel_message_ranges)
  return _impl_.unlocked_chat_wheel_message_ranges_;
}

// optional .CMsgLobbyPlayerPlusSubscriptionData plus_subscription_data = 16;
inline bool CMsgLobbyEventPoints_AccountPoints::_internal_has_plus_subscription_data() const {
  bool value = (_impl_._has_bits_[0] & 0x00000001u) != 0;
  PROTOBUF_ASSUME(!value || _impl_.plus_subscription_data_ != nullptr);
  return value;
}
inline bool CMsgLobbyEventPoints_AccountPoints::has_plus_subscription_data() const {
  return _internal_has_plus_subscription_data();
}
inline void CMsgLobbyEventPoints_AccountPoints::clear_plus_subscription_data() {
  if (_impl_.plus_subscription_data_ != nullptr) _impl_.plus_subscription_data_->Clear();
  _impl_._has_bits_[0] &= ~0x00000001u;
}
inline const ::CMsgLobbyPlayerPlusSubscriptionData& CMsgLobbyEventPoints_AccountPoints::_internal_plus_subscription_data() const {
  const ::CMsgLobbyPlayerPlusSubscriptionData* p = _impl_.plus_subscription_data_;
  return p != nullptr ? *p : reinterpret_cast<const ::CMsgLobbyPlayerPlusSubscriptionData&>(
      ::_CMsgLobbyPlayerPlusSubscriptionData_default_instance_);
}
inline const ::CMsgLobbyPlayerPlusSubscriptionData& CMsgLobbyEventPoints_AccountPoints::plus_subscription_data() const {
  // @@protoc_insertion_point(field_get:CMsgLobbyEventPoints.AccountPoints.plus_subscription_data)
  return _internal_plus_subscription_data();
}
inline void CMsgLobbyEventPoints_AccountPoints::unsafe_arena_set_allocated_plus_subscription_data(
    ::CMsgLobbyPlayerPlusSubscriptionData* plus_subscription_data) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.plus_subscription_data_);
  }
  _impl_.plus_subscription_data_ = plus_subscription_data;
  if (plus_subscription_data) {
    _impl_._has_bits_[0] |= 0x00000001u;
  } else {
    _impl_._has_bits_[0] &= ~0x00000001u;
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:CMsgLobbyEventPoints.AccountPoints.plus_subscription_data)
}
inline ::CMsgLobbyPlayerPlusSubscriptionData* CMsgLobbyEventPoints_AccountPoints::release_plus_subscription_data() {
  _impl_._has_bits_[0] &= ~0x00000001u;
  ::CMsgLobbyPlayerPlusSubscriptionData* temp = _impl_.plus_subscription_data_;
  _impl_.plus_subscription_data_ = nullptr;
...
inline ::CMsgLobbyPlayerPlusSubscriptionData* CMsgLobbyEventPoints_AccountPoints::unsafe_arena_release_plus_subscription_data() {
  // @@protoc_insertion_point(field_release:CMsgLobbyEventPoints.AccountPoints.plus_subscription_data)
  _impl_._has_bits_[0] &= ~0x00000001u;
  ::CMsgLobbyPlayerPlusSubscriptionData* temp = _impl_.plus_subscription_data_;
  _impl_.plus_subscription_data_ = nullptr;
  return temp;
}
inline ::CMsgLobbyPlayerPlusSubscriptionData* CMsgLobbyEventPoints_AccountPoints::_internal_mutable_plus_subscription_data() {
  _impl_._has_bits_[0] |= 0x00000001u;
  if (_impl_.plus_subscription_data_ == nullptr) {
    auto* p = CreateMaybeMessage<::CMsgLobbyPlayerPlusSubscriptionData>(GetArenaForAllocation());
    _impl_.plus_subscription_data_ = p;
  }
  return _impl_.plus_subscription_data_;
}
inline ::CMsgLobbyPlayerPlusSubscriptionData* CMsgLobbyEventPoints_AccountPoints::mutable_plus_subscription_data() {
  ::CMsgLobbyPlayerPlusSubscriptionData* _msg = _internal_mutable_plus_subscription_data();
  // @@protoc_insertion_point(field_mutable:CMsgLobbyEventPoints.AccountPoints.plus_subscription_data)
  return _msg;
}
inline void CMsgLobbyEventPoints_AccountPoints::set_allocated_plus_subscription_data(::CMsgLobbyPlayerPlusSubscriptionData* plus_subscription_data) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete _impl_.plus_subscription_data_;
  }
  if (plus_subscription_data) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalGetOwningArena(plus_subscription_data);
    if (message_arena != submessage_arena) {
      plus_subscription_data = ::PROTOBUF_NAMESPACE_ID::internal::GetOwnedMessage(
  ...
  _impl_.plus_subscription_data_ = plus_subscription_data;
  // @@protoc_insertion_point(field_set_allocated:CMsgLobbyEventPoints.AccountPoints.plus_subscription_data)
}

// repeated .CMsgLobbyEventPoints.PingWheelMessageRange unlocked_ping_wheel_message_ranges = 22;
inline int CMsgLobbyEventPoints_AccountPoints::_internal_unlocked_ping_wheel_message_ranges_size() const {
  return _impl_.unlocked_ping_wheel_message_ranges_.size();
}
inline int CMsgLobbyEventPoints_AccountPoints::unlocked_ping_wheel_message_ranges_size() const {
  return _internal_unlocked_ping_wheel_message_ranges_size();
}
inline void CMsgLobbyEventPoints_AccountPoints::clear_unlocked_ping_wheel_message_ranges() {
  _impl_.unlocked_ping_wheel_message_ranges_.Clear();
}
inline ::CMsgLobbyEventPoints_PingWheelMessageRange* CMsgLobbyEventPoints_AccountPoints::mutable_unlocked_ping_wheel_message_ranges(int index) {
  // @@protoc_insertion_point(field_mutable:CMsgLobbyEventPoints.AccountPoints.unlocked_ping_wheel_message_ranges)
  return _impl_.unlocked_ping_wheel_message_ranges_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::CMsgLobbyEventPoints_PingWheelMessageRange >*
CMsgLobbyEventPoints_AccountPoints::mutable_unlocked_ping_wheel_message_ranges() {
  // @@protoc_insertion_point(field_mutable_list:CMsgLobbyEventPoints.AccountPoints.unlocked_ping_wheel_message_ranges)
  return &_impl_.unlocked_ping_wheel_message_ranges_;
}
inline const ::CMsgLobbyEventPoints_PingWheelMessageRange& CMsgLobbyEventPoints_AccountPoints::_internal_unlocked_ping_wheel_message_ranges(int index) const {
  return _impl_.unlocked_ping_wheel_message_ranges_.Get(index);
}
inline const ::CMsgLobbyEventPoints_PingWheelMessageRange& CMsgLobbyEventPoints_AccountPoints::unlocked_ping_wheel_message_ranges(int index) const {
  // @@protoc_insertion_point(field_get:CMsgLobbyEventPoints.AccountPoints.unlocked_ping_wheel_message_ranges)
  return _internal_unlocked_ping_wheel_message_ranges(index);
}
inline ::CMsgLobbyEventPoints_PingWheelMessageRange* CMsgLobbyEventPoints_AccountPoints::_internal_add_unlocked_ping_wheel_message_ranges() {
  return _impl_.unlocked_ping_wheel_message_ranges_.Add();
}
inline ::CMsgLobbyEventPoints_PingWheelMessageRange* CMsgLobbyEventPoints_AccountPoints::add_unlocked_ping_wheel_message_ranges() {
  ::CMsgLobbyEventPoints_PingWheelMessageRange* _add = _internal_add_unlocked_ping_wheel_message_ranges();
  // @@protoc_insertion_point(field_add:CMsgLobbyEventPoints.AccountPoints.unlocked_ping_wheel_message_ranges)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::CMsgLobbyEventPoints_PingWheelMessageRange >&
CMsgLobbyEventPoints_AccountPoints::unlocked_ping_wheel_message_ranges() const {
  // @@protoc_insertion_point(field_list:CMsgLobbyEventPoints.AccountPoints.unlocked_ping_wheel_message_ranges)
  return _impl_.unlocked_ping_wheel_message_ranges_;
}
...
inline void CSODOTALobbyMember::_internal_set_rank_tier_updated(bool value) {
  _impl_._has_bits_[0] |= 0x00040000u;
  _impl_.rank_tier_updated_ = value;
}
...
inline void CSODOTALobby::_internal_set_custom_game_uses_account_records(bool value) {
  _impl_._has_bits_[1] |= 0x08000000u;
  _impl_.custom_game_uses_account_records_ = value;
}
...
inline void CSODOTALobby::clear_lobby_mvp_account_id() {
  _impl_.lobby_mvp_account_id_ = 0u;
  _impl_._has_bits_[1] &= ~0x00400000u;
}
inline uint32_t CSODOTALobby::_internal_lobby_mvp_account_id() const {
  return _impl_.lobby_mvp_account_id_;
}
inline uint32_t CSODOTALobby::lobby_mvp_account_id() const {
  // @@protoc_insertion_point(field_get:CSODOTALobby.lobby_mvp_account_id)
  return _internal_lobby_mvp_account_id();
}
inline void CSODOTALobby::_internal_set_lobby_mvp_account_id(uint32_t value) {
  _impl_._has_bits_[1] |= 0x00400000u;
  _impl_.lobby_mvp_account_id_ = value;
}
inline void CSODOTALobby::set_lobby_mvp_account_id(uint32_t value) {
