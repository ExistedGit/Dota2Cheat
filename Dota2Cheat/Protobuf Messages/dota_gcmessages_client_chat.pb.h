...
inline uint32_t CMsgDOTAChatMessage::_internal_requested_ability_id() const {
  return _impl_.requested_ability_id_;
}
inline uint32_t CMsgDOTAChatMessage::requested_ability_id() const {
  // @@protoc_insertion_point(field_get:CMsgDOTAChatMessage.requested_ability_id)
  return _internal_requested_ability_id();
}
inline void CMsgDOTAChatMessage::_internal_set_requested_ability_id(uint32_t value) {
  _impl_._has_bits_[0] |= 0x40000000u;
  _impl_.requested_ability_id_ = value;
}
inline void CMsgDOTAChatMessage::set_requested_ability_id(uint32_t value) {
