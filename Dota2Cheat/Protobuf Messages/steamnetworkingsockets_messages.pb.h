...
class CMsgICERendezvous_Candidate final :
 ...
 public:
  ...
  ~CMsgICERendezvous_Candidate() override;
  explicit PROTOBUF_CONSTEXPR CMsgICERendezvous_Candidate(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  CMsgICERendezvous_Candidate* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  void MergeFrom( const CMsgICERendezvous_Candidate& from) {
    CMsgICERendezvous_Candidate::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
...
class CMsgICERendezvous final :
 ...
 public:
  ...
  PROTOBUF_NODISCARD ::CMsgICERendezvous_Candidate* release_add_candidate();
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void CMsgICERendezvous_Candidate::set_candidate(ArgT0&& arg0, ArgT... args) {
 _impl_._has_bits_[0] |= 0x00000001u;
...
inline const ::CMsgICERendezvous_Candidate& CMsgICERendezvous::_internal_add_candidate() const {
  const ::CMsgICERendezvous_Candidate* p = _impl_.add_candidate_;
...
inline ::CMsgICERendezvous_Candidate* CMsgICERendezvous::release_add_candidate() {
  _impl_._has_bits_[0] &= ~0x00000001u;
  ::CMsgICERendezvous_Candidate* temp = _impl_.add_candidate_;
...
inline ::CMsgICERendezvous_Candidate* CMsgICERendezvous::_internal_mutable_add_candidate() {
  ...
  if (_impl_.add_candidate_ == nullptr) {
    auto* p = CreateMaybeMessage<::CMsgICERendezvous_Candidate>(GetArenaForAllocation());
...
inline ::CMsgICERendezvous_Candidate* CMsgICERendezvous::mutable_add_candidate() {
  ::CMsgICERendezvous_Candidate* _msg = _internal_mutable_add_candidate();
