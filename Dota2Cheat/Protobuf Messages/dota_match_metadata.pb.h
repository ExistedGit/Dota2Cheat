...
class CDOTAMatchMetadata_Team_InventorySnapshot final :
 ...
 public:
  ...
  // repeated uint32 backpack_item_id = 7;
  ...
  private:
  uint32_t _internal_backpack_item_id(int index) const;
  const ::PROTOBUF_NAMESPACE_ID::RepeatedField< uint32_t >&
      _internal_backpack_item_id() const;
  void _internal_add_backpack_item_id(uint32_t value);
  ::PROTOBUF_NAMESPACE_ID::RepeatedField< uint32_t >*
      _internal_mutable_backpack_item_id();
  public:
  uint32_t backpack_item_id(int index) const;
  void set_backpack_item_id(int index, uint32_t value);
  void add_backpack_item_id(uint32_t value);
  const ::PROTOBUF_NAMESPACE_ID::RepeatedField< uint32_t >&
  ...
  // optional uint32 neutral_item_id = 8;
  bool has_neutral_item_id() const;
  private:
  bool _internal_has_neutral_item_id() const;
  public:
  void clear_neutral_item_id();
  uint32_t neutral_item_id() const;
  void set_neutral_item_id(uint32_t value);
  private:
  uint32_t _internal_neutral_item_id() const;
  void _internal_set_neutral_item_id(uint32_t value);
  public:
 ...
 private:
  ...
  struct Impl_ {
    ...
    ::PROTOBUF_NAMESPACE_ID::RepeatedField< uint32_t > backpack_item_id_;
    int32_t game_time_;
    uint32_t kills_;
    uint32_t deaths_;
    uint32_t assists_;
    uint32_t level_;
    uint32_t neutral_item_id_;
  };
  union { Impl_ _impl_; };
  friend struct ::TableStruct_dota_5fmatch_5fmetadata_2eproto;
};
...
class CDOTAMatchMetadata_Team_GauntletProgress final :
 ...
 public:
  ...
  ~CDOTAMatchMetadata_Team_GauntletProgress() override;
  explicit PROTOBUF_CONSTEXPR CDOTAMatchMetadata_Team_GauntletProgress(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  CDOTAMatchMetadata_Team_GauntletProgress* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  void MergeFrom( const CDOTAMatchMetadata_Team_GauntletProgress& from) {
    CDOTAMatchMetadata_Team_GauntletProgress::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  uint32_t gauntlet_tier() const;
  void set_gauntlet_tier(uint32_t value);
  private:
  uint32_t _internal_gauntlet_tier() const;
  void _internal_set_gauntlet_tier(uint32_t value);
  public:
  ...
  uint32_t gauntlet_wins() const;
  void set_gauntlet_wins(uint32_t value);
  private:
  uint32_t _internal_gauntlet_wins() const;
  void _internal_set_gauntlet_wins(uint32_t value);
  public:
  ...
  uint32_t gauntlet_losses() const;
  void set_gauntlet_losses(uint32_t value);
  private:
  uint32_t _internal_gauntlet_losses() const;
  void _internal_set_gauntlet_losses(uint32_t value);
  public:
 ...
 private:
  ...
  struct Impl_ {
    ::PROTOBUF_NAMESPACE_ID::internal::HasBits<1> _has_bits_;
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
    uint32_t gauntlet_tier_;
    uint32_t gauntlet_wins_;
    uint32_t gauntlet_losses_;
  };
  union { Impl_ _impl_; };
  friend struct ::TableStruct_dota_5fmatch_5fmetadata_2eproto;
};
...
class CDOTAMatchMetadata_Team_Player final :
 ...
 public:
  ...
  PROTOBUF_NODISCARD ::CDOTAMatchMetadata_Team_GauntletProgress* release_gauntlet_progress();
...
class CDOTAMatchPrivateMetadata_Team_Player_BuffRecord final :
 ...
 public:
  ...
  uint32_t buff_ability_id() const;
  void set_buff_ability_id(uint32_t value);
  private:
  uint32_t _internal_buff_ability_id() const;
  void _internal_set_buff_ability_id(uint32_t value);
  public:
...
inline uint32_t CDOTAMatchMetadata_Team_InventorySnapshot::_internal_backpack_item_id(int index) const {
  return _impl_.backpack_item_id_.Get(index);
}
inline uint32_t CDOTAMatchMetadata_Team_InventorySnapshot::backpack_item_id(int index) const {
...
inline void CDOTAMatchMetadata_Team_InventorySnapshot::set_backpack_item_id(int index, uint32_t value) {
...
inline void CDOTAMatchMetadata_Team_InventorySnapshot::_internal_add_backpack_item_id(uint32_t value) {
  _impl_.backpack_item_id_.Add(value);
}
inline void CDOTAMatchMetadata_Team_InventorySnapshot::add_backpack_item_id(uint32_t value) {
...
inline void CDOTAMatchMetadata_Team_InventorySnapshot::clear_neutral_item_id() {
  _impl_.neutral_item_id_ = 0u;
  _impl_._has_bits_[0] &= ~0x00000020u;
}
inline uint32_t CDOTAMatchMetadata_Team_InventorySnapshot::_internal_neutral_item_id() const {
  return _impl_.neutral_item_id_;
}
inline uint32_t CDOTAMatchMetadata_Team_InventorySnapshot::neutral_item_id() const {
...
inline void CDOTAMatchMetadata_Team_InventorySnapshot::_internal_set_neutral_item_id(uint32_t value) {
  _impl_._has_bits_[0] |= 0x00000020u;
  _impl_.neutral_item_id_ = value;
}
inline void CDOTAMatchMetadata_Team_InventorySnapshot::set_neutral_item_id(uint32_t value) {
...
inline void CDOTAMatchMetadata_Team_EventData::clear_cavern_crawl_map_variant() {
  _impl_.cavern_crawl_map_variant_ = 0u;
...
inline void CDOTAMatchMetadata_Team_GauntletProgress::clear_gauntlet_tier() {
  _impl_.gauntlet_tier_ = 0u;
  _impl_._has_bits_[0] &= ~0x00000001u;
}
inline uint32_t CDOTAMatchMetadata_Team_GauntletProgress::_internal_gauntlet_tier() const {
  return _impl_.gauntlet_tier_;
}
inline uint32_t CDOTAMatchMetadata_Team_GauntletProgress::gauntlet_tier() const {
  // @@protoc_insertion_point(field_get:CDOTAMatchMetadata.Team.GauntletProgress.gauntlet_tier)
  return _internal_gauntlet_tier();
}
inline void CDOTAMatchMetadata_Team_GauntletProgress::_internal_set_gauntlet_tier(uint32_t value) {
  _impl_._has_bits_[0] |= 0x00000001u;
  _impl_.gauntlet_tier_ = value;
}
inline void CDOTAMatchMetadata_Team_GauntletProgress::set_gauntlet_tier(uint32_t value) {
...
inline void CDOTAMatchMetadata_Team_GauntletProgress::clear_gauntlet_wins() {
  _impl_.gauntlet_wins_ = 0u;
  _impl_._has_bits_[0] &= ~0x00000002u;
}
inline uint32_t CDOTAMatchMetadata_Team_GauntletProgress::_internal_gauntlet_wins() const {
  return _impl_.gauntlet_wins_;
}
inline uint32_t CDOTAMatchMetadata_Team_GauntletProgress::gauntlet_wins() const {
  // @@protoc_insertion_point(field_get:CDOTAMatchMetadata.Team.GauntletProgress.gauntlet_wins)
  return _internal_gauntlet_wins();
}
inline void CDOTAMatchMetadata_Team_GauntletProgress::_internal_set_gauntlet_wins(uint32_t value) {
  _impl_._has_bits_[0] |= 0x00000002u;
  _impl_.gauntlet_wins_ = value;
}
inline void CDOTAMatchMetadata_Team_GauntletProgress::set_gauntlet_wins(uint32_t value) {
...
inline void CDOTAMatchMetadata_Team_GauntletProgress::clear_gauntlet_losses() {
  _impl_.gauntlet_losses_ = 0u;
  _impl_._has_bits_[0] &= ~0x00000004u;
}
inline uint32_t CDOTAMatchMetadata_Team_GauntletProgress::_internal_gauntlet_losses() const {
  return _impl_.gauntlet_losses_;
}
inline uint32_t CDOTAMatchMetadata_Team_GauntletProgress::gauntlet_losses() const {
...
inline void CDOTAMatchMetadata_Team_GauntletProgress::_internal_set_gauntlet_losses(uint32_t value) {
  _impl_._has_bits_[0] |= 0x00000004u;
  _impl_.gauntlet_losses_ = value;
}
inline void CDOTAMatchMetadata_Team_GauntletProgress::set_gauntlet_losses(uint32_t value) {
...
inline bool CDOTAMatchMetadata_Team_Player::_internal_has_gauntlet_progress() const {
  bool value = (_impl_._has_bits_[0] & 0x00000001u) != 0;
  PROTOBUF_ASSUME(!value || _impl_.gauntlet_progress_ != nullptr);
  return value;
}
...
inline void CDOTAMatchMetadata_Team_Player::clear_gauntlet_progress() {
  if (_impl_.gauntlet_progress_ != nullptr) _impl_.gauntlet_progress_->Clear();
  _impl_._has_bits_[0] &= ~0x00000001u;
}
inline const ::CDOTAMatchMetadata_Team_GauntletProgress& CDOTAMatchMetadata_Team_Player::_internal_gauntlet_progress() const {
  const ::CDOTAMatchMetadata_Team_GauntletProgress* p = _impl_.gauntlet_progress_;
...
inline void CDOTAMatchMetadata_Team_Player::unsafe_arena_set_allocated_gauntlet_progress(
    ::CDOTAMatchMetadata_Team_GauntletProgress* gauntlet_progress) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.gauntlet_progress_);
  }
  _impl_.gauntlet_progress_ = gauntlet_progress;
...
inline ::CDOTAMatchMetadata_Team_GauntletProgress* CDOTAMatchMetadata_Team_Player::release_gauntlet_progress() {
  _impl_._has_bits_[0] &= ~0x00000001u;
  ::CDOTAMatchMetadata_Team_GauntletProgress* temp = _impl_.gauntlet_progress_;
  _impl_.gauntlet_progress_ = nullptr;
#ifdef PROTOBUF_FORCE_COPY_IN_RELEASE
  auto* old =  reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(temp);
  temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
  if (GetArenaForAllocation() == nullptr) { delete old; }
...
inline ::CDOTAMatchMetadata_Team_GauntletProgress* CDOTAMatchMetadata_Team_Player::_internal_mutable_gauntlet_progress() {
  _impl_._has_bits_[0] |= 0x00000001u;
  if (_impl_.gauntlet_progress_ == nullptr) {
    auto* p = CreateMaybeMessage<::CDOTAMatchMetadata_Team_GauntletProgress>(GetArenaForAllocation());
    _impl_.gauntlet_progress_ = p;
  }
  return _impl_.gauntlet_progress_;
}
inline ::CDOTAMatchMetadata_Team_GauntletProgress* CDOTAMatchMetadata_Team_Player::mutable_gauntlet_progress() {
  ::CDOTAMatchMetadata_Team_GauntletProgress* _msg = _internal_mutable_gauntlet_progress();
...
inline void CDOTAMatchMetadata_Team_Player::set_allocated_gauntlet_progress(::CDOTAMatchMetadata_Team_GauntletProgress* gauntlet_progress) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete _impl_.gauntlet_progress_;
  }
  if (gauntlet_progress) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalGetOwningArena(gauntlet_progress);
    if (message_arena != submessage_arena) {
...
inline void CDOTAMatchMetadata_Team::clear_cm_captain_player_id() {
  _impl_.cm_captain_player_id_ = 0;
  _impl_._has_bits_[0] &= ~0x00000004u;
}
...
inline void CDOTAMatchMetadata_Team::set_cm_bans(int index, uint32_t value) {
  _impl_.cm_bans_.Set(index, value);
...
inline void CDOTAMatchMetadata_Team::set_cm_picks(int index, uint32_t value) {
  _impl_.cm_picks_.Set(index, value);
...
inline uint32_t CDOTAMatchMetadata_GuildChallengeProgress_IndividualProgress::_internal_account_id() const {
  return _impl_.account_id_;
}
inline uint32_t CDOTAMatchMetadata_GuildChallengeProgress_IndividualProgress::account_id() const {
  // @@protoc_insertion_point(field_get:CDOTAMatchMetadata.GuildChallengeProgress.IndividualProgress.account_id)
  return _internal_account_id();
}
inline void CDOTAMatchMetadata_GuildChallengeProgress_IndividualProgress::_internal_set_account_id(uint32_t value) {
  _impl_._has_bits_[0] |= 0x00000001u;
  _impl_.account_id_ = value;
}
inline void CDOTAMatchMetadata_GuildChallengeProgress_IndividualProgress::set_account_id(uint32_t value) {
  _internal_set_account_id(value);
...
inline int CDOTAMatchMetadata::_internal_item_rewards_size() const {
  return _impl_.item_rewards_.size();
}
...
inline ::CLobbyTimedRewardDetails* CDOTAMatchMetadata::mutable_item_rewards(int index) {
  ...
  return _impl_.item_rewards_.Mutable(index);
}
...
inline ::CLobbyTimedRewardDetails* CDOTAMatchMetadata::_internal_add_item_rewards() {
  return _impl_.item_rewards_.Add();
}
...
inline uint32_t CDOTAMatchPrivateMetadata_Team_Player_CombatSegment_DamageByAbility::_internal_ability_id() const {
  return _impl_.ability_id_;
}
inline uint32_t CDOTAMatchPrivateMetadata_Team_Player_CombatSegment_DamageByAbility::ability_id() const {
...
inline void CDOTAMatchPrivateMetadata_Team_Player_CombatSegment_DamageByAbility::_internal_set_ability_id(uint32_t value) {
  _impl_._has_bits_[0] |= 0x00000001u;
  _impl_.ability_id_ = value;
}
inline void CDOTAMatchPrivateMetadata_Team_Player_CombatSegment_DamageByAbility::set_ability_id(uint32_t value) {
...
inline uint32_t CDOTAMatchPrivateMetadata_Team_Player_CombatSegment_HealingByAbility::_internal_ability_id() const {
  return _impl_.ability_id_;
}
inline uint32_t CDOTAMatchPrivateMetadata_Team_Player_CombatSegment_HealingByAbility::ability_id() const {
  // @@protoc_insertion_point(field_get:CDOTAMatchPrivateMetadata.Team.Player.CombatSegment.HealingByAbility.ability_id)
  return _internal_ability_id();
}
inline void CDOTAMatchPrivateMetadata_Team_Player_CombatSegment_HealingByAbility::_internal_set_ability_id(uint32_t value) {
  _impl_._has_bits_[0] |= 0x00000001u;
  _impl_.ability_id_ = value;
}
inline void CDOTAMatchPrivateMetadata_Team_Player_CombatSegment_HealingByAbility::set_ability_id(uint32_t value) {
  _internal_set_ability_id(value);
...
inline void CDOTAMatchPrivateMetadata_Team_Player_BuffRecord::clear_buff_ability_id() {
  _impl_.buff_ability_id_ = 0u;
  _impl_._has_bits_[0] &= ~0x00000002u;
}
inline uint32_t CDOTAMatchPrivateMetadata_Team_Player_BuffRecord::_internal_buff_ability_id() const {
  return _impl_.buff_ability_id_;
}
inline uint32_t CDOTAMatchPrivateMetadata_Team_Player_BuffRecord::buff_ability_id() const {
...
inline void CDOTAMatchPrivateMetadata_Team_Player_BuffRecord::_internal_set_buff_ability_id(uint32_t value) {
  _impl_._has_bits_[0] |= 0x00000002u;
  _impl_.buff_ability_id_ = value;
}
inline void CDOTAMatchPrivateMetadata_Team_Player_BuffRecord::set_buff_ability_id(uint32_t value) {
...
inline uint32_t CDOTAMatchPrivateMetadata_Team_Player::_internal_account_id() const {
  return _impl_.account_id_;
}
inline uint32_t CDOTAMatchPrivateMetadata_Team_Player::account_id() const {
  // @@protoc_insertion_point(field_get:CDOTAMatchPrivateMetadata.Team.Player.account_id)
  return _internal_account_id();
}
inline void CDOTAMatchPrivateMetadata_Team_Player::_internal_set_account_id(uint32_t value) {
  _impl_._has_bits_[0] |= 0x00000008u;
  _impl_.account_id_ = value;
}
inline void CDOTAMatchPrivateMetadata_Team_Player::set_account_id(uint32_t value) {
  _internal_set_account_id(value);
