...
inline uint32_t CMvpData_MvpDatum::_internal_slot() const {
  return _impl_.slot_;
}
inline uint32_t CMvpData_MvpDatum::slot() const {
  // @@protoc_insertion_point(field_get:CMvpData.MvpDatum.slot)
  return _internal_slot();
}
inline void CMvpData_MvpDatum::_internal_set_slot(uint32_t value) {
  _impl_._has_bits_[0] |= 0x00000001u;
  _impl_.slot_ = value;
}
inline void CMvpData_MvpDatum::set_slot(uint32_t value) {
...
inline uint32_t CMvpData_MvpDatum::_internal_account_id() const {
  return _impl_.account_id_;
}
inline uint32_t CMvpData_MvpDatum::account_id() const {
  // @@protoc_insertion_point(field_get:CMvpData.MvpDatum.account_id)
  return _internal_account_id();
}
inline void CMvpData_MvpDatum::_internal_set_account_id(uint32_t value) {
  _impl_._has_bits_[0] |= 0x00000002u;
  _impl_.account_id_ = value;
}
inline void CMvpData_MvpDatum::set_account_id(uint32_t value) {
  _internal_set_account_id(value);
