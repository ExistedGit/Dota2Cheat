...
public:
    ...
    virtual void* C_BaseEntity__MyInfectedPointer(void); // Note: One of these is missing, couldn't tell which one, they all return 0 --- 
    //virtual void* C_BaseEntity__MyInfectedRagdollPointer(void); Removed this one
