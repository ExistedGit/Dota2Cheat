...
public:
    ...
    virtual void SendNetMessage(/*NetMessageHandle_t*/void* messageHandle, void* message, NetChannelBufType_t type) = 0;
    ...
    virtual void PostReceivedNetMessage(void *, void* ,NetChannelBufType_t const*, int) = 0;
