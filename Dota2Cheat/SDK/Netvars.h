...
namespace Netvars {
	namespace C_DOTA_BaseNPC_Hero {
		...
		constexpr uint32_t m_iCurrentXP = 0x1758; // int32
		constexpr uint32_t m_iAbilityPoints = 0x175c; // int32
		constexpr uint32_t m_flRespawnTime = 0x1760; // GameTime_t
		constexpr uint32_t m_flRespawnTimePenalty = 0x1764; // float32
		constexpr uint32_t m_flStrength = 0x1768; // float32
		constexpr uint32_t m_flAgility = 0x176c; // float32
		constexpr uint32_t m_flIntellect = 0x1770; // float32
		constexpr uint32_t m_flStrengthTotal = 0x1774; // float32
		constexpr uint32_t m_flAgilityTotal = 0x1778; // float32
		constexpr uint32_t m_flIntellectTotal = 0x177c; // float32
		constexpr uint32_t m_flDeathTime = 0x1780; // GameTime_t
		constexpr uint32_t m_iRecentDamage = 0x1784; // int32
		constexpr uint32_t m_fPainFactor = 0x1788; // float32
		constexpr uint32_t m_fTargetPainFactor = 0x178c; // float32
		constexpr uint32_t m_bLifeState = 0x1790; // bool
		constexpr uint32_t m_nFXStunIndex = 0x1794; // ParticleIndex_t
		constexpr uint32_t m_nFXSilenceIndex = 0x1798; // ParticleIndex_t
		constexpr uint32_t m_nFXDeathIndex = 0x179c; // ParticleIndex_t
		constexpr uint32_t m_iPlayerID = 0x17c0; // PlayerID_t
		constexpr uint32_t m_hReplicatingOtherHeroModel = 0x17c4; // CHandle< C_DOTA_BaseNPC_Hero >
		constexpr uint32_t m_bReincarnating = 0x17c8; // bool
		constexpr uint32_t m_bCustomKillEffect = 0x17c9; // bool
		constexpr uint32_t m_flSpawnedAt = 0x17cc; // GameTime_t
		constexpr uint32_t m_bScriptDisableRespawns = 0x17d0; // bool
		constexpr uint32_t m_iPrimaryAttribute = 0x17d4; // int32
		constexpr uint32_t m_nLastDrawnHealth = 0x17d8; // int32
		constexpr uint32_t m_flHurtAmount = 0x17dc; // float32
		constexpr uint32_t m_flLastHurtTime = 0x17e0; // GameTime_t
		constexpr uint32_t m_flHurtDecayRate = 0x17e4; // float32
		constexpr uint32_t m_flLastHealTime = 0x17e8; // GameTime_t
		constexpr uint32_t m_flLastTreeShakeTime = 0x17ec; // GameTime_t
		constexpr uint32_t m_CenterOnHeroCooldownTimer = 0x17f0; // CountdownTimer
		constexpr uint32_t m_CombinedModels = 0x1a10; // CStrongHandle< InfoForResourceTypeCModel >[4]
		constexpr uint32_t m_nCurrentCombinedModelIndex = 0x1a30; // int32
		constexpr uint32_t m_nPendingCombinedModelIndex = 0x1a34; // int32
		constexpr uint32_t m_iHeroID = 0x1a38; // int32
		constexpr uint32_t m_flCheckLegacyItemsAt = 0x1a3c; // float32
		constexpr uint32_t m_bDisplayAdditionalHeroes = 0x1a40; // bool
		constexpr uint32_t m_CombinedParticleModels = 0x1a50; // CStrongHandle< InfoForResourceTypeCModel >[4]
		constexpr uint32_t m_vecAttachedParticleIndeces = 0x1a70; // CUtlVector< ParticleIndex_t >
		constexpr uint32_t m_hPets = 0x1a88; // CUtlVector< CHandle< C_BaseEntity > >
		constexpr uint32_t m_nKillStreakFX = 0x1aa0; // ParticleIndex_t
		constexpr uint32_t m_nKillStreakFXTier = 0x1aa4; // int32
	}
	...
	namespace C_DOTA_BaseNPC {
		...
		constexpr uint32_t m_Inventory = 0xea0; // C_DOTA_UnitInventory
		constexpr uint32_t m_nUnitState64 = 0xf58; // uint64
		constexpr uint32_t m_nUnitDebuffState = 0xf68; // uint64
		constexpr uint32_t m_bHasInventory = 0xf70; // bool
		constexpr uint32_t m_iAcquisitionRange = 0xf74; // int32
		constexpr uint32_t m_FoWViewID = 0xf78; // int32
		constexpr uint32_t m_iPrevHealthPct = 0xf7c; // int32
		constexpr uint32_t m_iPrevLifeState = 0xf80; // int32
		constexpr uint32_t m_iPrevTeam = 0xf84; // int32
		constexpr uint32_t m_bPrevProvidesVision = 0xf88; // bool
		constexpr uint32_t m_nPrevControllableMask = 0xf90; // uint64
		constexpr uint32_t m_TagTime = 0xfa0; // CountdownTimer
		constexpr uint32_t m_ClickedTime = 0xfb8; // CountdownTimer
		constexpr uint32_t m_flIdleRunPoseStartTime = 0xfd0; // GameTime_t[2]
		constexpr uint32_t m_flIdleRunPoseDuration = 0xfd8; // float32[2]
		constexpr uint32_t m_bAnimationTransitionActive = 0xfe0; // bool
		constexpr uint32_t m_nAnimationTransitionPoseParameters = 0xfe4; // int32[2]
		constexpr uint32_t m_nAnimationTransitionInjuredPoseParameters = 0xfec; // int32[2]
		constexpr uint32_t m_nAnimationTransitionAggressivePoseParameters = 0xff4; // int32[2]
		constexpr uint32_t m_flTimeSinceLastAbilityNag = 0x1058; // GameTime_t
		constexpr uint32_t m_iAttackCapabilities = 0x105c; // int32
		constexpr uint32_t m_iSpecialAbility = 0x1060; // int32
		constexpr uint32_t m_iMoveCapabilities = 0x1064; // int32
		constexpr uint32_t m_nPlayerOwnerID = 0x1068; // PlayerID_t
		constexpr uint32_t m_flLastDamageTime = 0x106c; // GameTime_t
		constexpr uint32_t m_flLastAttackTime = 0x1070; // GameTime_t
		constexpr uint32_t m_iszMinimapIcon = 0x1078; // CUtlSymbolLarge
		constexpr uint32_t m_flMinimapIconSize = 0x1088; // float32
		constexpr uint32_t m_bMinimapDisableTint = 0x108c; // bool
		constexpr uint32_t m_bMinimapDisableRotation = 0x108d; // bool
		constexpr uint32_t m_colorHeroGlow = 0x108e; // Color
		constexpr uint32_t m_iNearShopMask = 0x1094; // int32
		constexpr uint32_t m_nPoseParameterTurn = 0x1098; // int32
		constexpr uint32_t m_nPoseParameterRun = 0x109c; // int32
		constexpr uint32_t m_flLean = 0x10a0; // float32
		constexpr uint32_t m_flRun = 0x10a4; // float32
		constexpr uint32_t m_anglediff = 0x10a8; // int32
		constexpr uint32_t m_bInfoKeyActive = 0x10ac; // bool
		constexpr uint32_t m_bNewUpdateAssetModifiersNetworked = 0x10ad; // bool
		constexpr uint32_t m_nAssetModifiersLastUpdatedTick = 0x10b0; // GameTick_t
		constexpr uint32_t m_bSuppressGlow = 0x10b4; // bool
		constexpr uint32_t m_bWasSinking = 0x10b5; // bool
		constexpr uint32_t m_flRangeDisplayDist = 0x10b8; // float32
		constexpr uint32_t m_szDefaultIdle = 0x12a0; // CUtlSymbolLarge
		constexpr uint32_t m_szDefaultRareIdle = 0x12a8; // CUtlSymbolLarge
		constexpr uint32_t m_damagetimer = 0x12b0; // CountdownTimer
		constexpr uint32_t m_vRenderOrigin = 0x12c8; // Vector
		constexpr uint32_t m_fZDelta = 0x12d4; // float32
		constexpr uint32_t m_flDeathTime = 0x12d8; // GameTime_t
		constexpr uint32_t m_bBaseStatsChanged = 0x12dc; // bool
		constexpr uint32_t m_bNeedsSoundEmitterRefresh = 0x12dd; // bool
		constexpr uint32_t m_flPhysicalArmorValue = 0x12e0; // float32
		constexpr uint32_t m_flMagicalResistanceValue = 0x12e4; // float32
		constexpr uint32_t m_nPrevSequenceParity = 0x12e8; // int32
		constexpr uint32_t m_flPrevInvisLevel = 0x1390; // float32
		constexpr uint32_t m_nOriginalModelIndex = 0x1398; // CStrongHandle< InfoForResourceTypeCModel >
		constexpr uint32_t m_nClientOriginalModelIndex = 0x13a0; // CStrongHandle< InfoForResourceTypeCModel >
		constexpr uint32_t m_nClientReplacementModelIndex = 0x13a8; // CStrongHandle< InfoForResourceTypeCModel >
		constexpr uint32_t m_bClientReplacementModelNeedsRebuild = 0x13b0; // bool
		constexpr uint32_t m_nClientReplacementModelReloadCount = 0x13b4; // int32
		constexpr uint32_t m_nUnitModelVariant = 0x13b8; // int8
		constexpr uint32_t m_nUnitModelVariantCount = 0x13b9; // int8
		constexpr uint32_t m_iPrevSequence = 0x13bc; // int32
		constexpr uint32_t m_pLastWeatherEffectName = 0x13c0; // char*
		constexpr uint32_t m_VoiceBackgroundSoundTimer = 0x13d0; // CountdownTimer
		constexpr uint32_t m_bIsWaitingToSpawn = 0x13e8; // bool
		constexpr uint32_t m_nTotalDamageTaken = 0x13f0; // int64
		constexpr uint32_t m_flManaRegen = 0x13f8; // float32
		constexpr uint32_t m_flHealthRegen = 0x13fc; // float32
		constexpr uint32_t m_bIsMoving = 0x1400; // bool
		constexpr uint32_t m_fRevealRadius = 0x1404; // float32
		constexpr uint32_t m_bCanUseWards = 0x1408; // bool
		constexpr uint32_t m_bCanUseAllItems = 0x1409; // bool
		constexpr uint32_t m_iXPBounty = 0x140c; // int32
		constexpr uint32_t m_iXPBountyExtra = 0x1410; // int32
		constexpr uint32_t m_iGoldBountyMin = 0x1414; // int32
		constexpr uint32_t m_iGoldBountyMax = 0x1418; // int32
		constexpr uint32_t m_hOwnerNPC = 0x141c; // CHandle< C_BaseEntity >
		constexpr uint32_t m_hGoalEntity = 0x1420; // CHandle< C_BaseEntity >
		constexpr uint32_t m_hNeutralSpawner = 0x1424; // CHandle< C_DOTA_NeutralSpawner >
		constexpr uint32_t m_hClientOverrideMaterial = 0x1428; // CStrongHandle< InfoForResourceTypeIMaterial2 >
		constexpr uint32_t m_bCombinerMaterialOverrideListChanged = 0x1430; // bool
		constexpr uint32_t m_nBaseModelMeshCount = 0x1434; // int32
		constexpr uint32_t m_combinerMaterialOverrideList = 0x1438; // CUtlVector< CStrongHandleCopyable< InfoForResourceTypeIMaterial2 > >
		constexpr uint32_t m_nArcanaLevel = 0x1450; // int8
		constexpr uint32_t m_nDefaultArcanaLevel = 0x1451; // int8
		constexpr uint32_t m_defaultColorGemColor = 0x1452; // Color
		constexpr uint32_t m_bHasBuiltWearableSpawnList = 0x1470; // bool
		constexpr uint32_t m_bHasCostume = 0x1471; // bool
		constexpr uint32_t m_bRecreateParticleSystemsOnModifiersChange = 0x1472; // bool
		constexpr uint32_t m_NetworkActivity = 0x1590; // int32
		constexpr uint32_t m_PrevNetworkActivity = 0x1594; // int32
		constexpr uint32_t m_NetworkSequenceIndex = 0x1598; // int32
		constexpr uint32_t m_bShouldDoFlyHeightVisual = 0x159c; // bool
		constexpr uint32_t m_flStartSequenceCycle = 0x15a0; // float32
		constexpr uint32_t m_ActivityModifiers = 0x15a8; // CUtlVector< CUtlSymbol >
		constexpr uint32_t m_hBackgroundSceneEnt = 0x15c0; // CHandle< C_SceneEntity >
		constexpr uint32_t m_hSpeakingSceneEnt = 0x15c4; // CHandle< C_SceneEntity >
		constexpr uint32_t m_hOldWearables = 0x15d8; // CUtlVector< CHandle< C_EconWearable > >
		constexpr uint32_t m_hOldWearableSkins = 0x15f0; // CUtlVector< CUtlStringToken >
		constexpr uint32_t m_CustomHealthLabel = 0x1608; // char[256]
		constexpr uint32_t m_CustomHealthLabelColor = 0x1708; // Color
		constexpr uint32_t m_nWearableDefIndex = 0x170c; // item_definition_index_t
		constexpr uint32_t m_gibTintColor = 0x1711; // Color
		constexpr uint32_t m_bForceMaterialCombine = 0x1715; // bool
		constexpr uint32_t m_bShouldDrawParticlesWhileHidden = 0x1716; // bool
		constexpr uint32_t m_bIsClientThinkPending = 0x1717; // bool
		constexpr uint32_t m_bActivityModifiersDirty = 0x1718; // bool
		constexpr uint32_t m_bUnitModelVariantChanged = 0x1719; // bool
		constexpr uint32_t m_bWearablesAreTaunting = 0x171a; // bool
		constexpr uint32_t m_bShowCannotBeDisabledIcon = 0x1730; // bool
	}
	...
	namespace C_DOTAPlayerController {
		...
		constexpr uint32_t m_vecSuggestedWardLocationEffects = 0x988; // CUtlVector< ParticleIndex_t >
		constexpr uint32_t m_pSmartCastNPC = 0x9a0; // C_DOTA_BaseNPC*
		constexpr uint32_t m_nTeamSprayParticleIndex = 0x9a8; // ParticleIndex_t
		constexpr uint32_t m_bIsNextCastOrderFromMouseClick = 0x9ac; // bool
		constexpr uint32_t m_iCursor = 0x9e0; // int32[2]
		constexpr uint32_t m_iSpectatorClickBehavior = 0x9e8; // int32
		constexpr uint32_t m_flAspectRatio = 0x9ec; // float32
		constexpr uint32_t m_hSpectatorQueryUnit = 0x9f0; // CHandle< C_BaseEntity >
		constexpr uint32_t m_iStatsPanel = 0x9f4; // int32
		constexpr uint32_t m_iShopPanel = 0x9f8; // int32
		constexpr uint32_t m_iShopViewMode = 0x9fc; // ShopItemViewMode_t
		constexpr uint32_t m_iStatsDropdownCategory = 0xa00; // int32
		constexpr uint32_t m_iStatsDropdownSort = 0xa04; // int32
		constexpr uint32_t m_szShopString = 0xa08; // char[64]
		constexpr uint32_t m_vecClientQuickBuyState = 0xa48; // C_UtlVectorEmbeddedNetworkVar< ClientQuickBuyItemState >
		constexpr uint32_t m_bInShowCaseMode = 0xa98; // bool
		constexpr uint32_t m_flCameraZoomAmount = 0xa9c; // float32
		constexpr uint32_t m_iHighPriorityScore = 0xaa0; // int32
		constexpr uint32_t m_quickBuyItems = 0xaa4; // AbilityID_t[9]
		constexpr uint32_t m_quickBuyIsPurchasable = 0xac8; // bool[9]
		constexpr uint32_t m_flFrameTime = 0xad4; // float32
		constexpr uint32_t m_flFrameTimeStdDev = 0xad8; // float32
		constexpr uint32_t m_flUnfilteredFrameTime = 0xadc; // float32
		constexpr uint32_t m_NeutralCampAlarms = 0xae0; // CUtlVector< NeutralCampStackPullAlarm_t >
		constexpr uint32_t m_iPrevCursor = 0xaf8; // int32[2]
		constexpr uint32_t m_iPositionHistoryTail = 0xba0; // int32
		constexpr uint32_t m_iMusicStatus = 0xba4; // int32
		constexpr uint32_t m_iPreviousMusicStatus = 0xba8; // int32
		constexpr uint32_t m_bRequestedInventory = 0xbac; // bool
		constexpr uint32_t m_flMusicOperatorVals = 0xbb0; // float32[3]
		constexpr uint32_t m_iMusicOperatorVals = 0xbbc; // int32[4]
		constexpr uint32_t m_ControlGroups = 0xbd0; // CUtlVector< sControlGroupElem >[10]
		constexpr uint32_t m_pkvControlGroupKV = 0xcc0; // KeyValues*
		constexpr uint32_t m_flAltHeldStartTime = 0xd20; // float32
	}
