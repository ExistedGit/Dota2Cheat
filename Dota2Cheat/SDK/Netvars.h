...
namespace Netvars {
	namespace C_DOTA_BaseNPC_Hero {
		...
		constexpr uint32_t m_iCurrentXP = 0x1808; // int32
		constexpr uint32_t m_iAbilityPoints = 0x180c; // int32
		constexpr uint32_t m_iTotalAbilityPoints = 0x1810; // int32
		constexpr uint32_t m_flRespawnTime = 0x1814; // GameTime_t
		constexpr uint32_t m_flRespawnTimePenalty = 0x1818; // float32
		constexpr uint32_t m_flStrength = 0x181c; // float32
		constexpr uint32_t m_flAgility = 0x1820; // float32
		constexpr uint32_t m_flIntellect = 0x1824; // float32
		constexpr uint32_t m_flStrengthTotal = 0x1828; // float32
		constexpr uint32_t m_flAgilityTotal = 0x182c; // float32
		constexpr uint32_t m_flIntellectTotal = 0x1830; // float32
		constexpr uint32_t m_hFacetAbilities = 0x1838; // C_NetworkUtlVectorBase< CHandle< C_BaseEntity > >
		constexpr uint32_t m_iRecentDamage = 0x1850; // int32
		constexpr uint32_t m_fPainFactor = 0x1854; // float32
		constexpr uint32_t m_fTargetPainFactor = 0x1858; // float32
		constexpr uint32_t m_bLifeState = 0x185c; // bool
		constexpr uint32_t m_bFirstSpawn = 0x185d; // bool
		constexpr uint32_t m_nFXStunIndex = 0x1860; // ParticleIndex_t
		constexpr uint32_t m_nFXSilenceIndex = 0x1864; // ParticleIndex_t
		constexpr uint32_t m_nFXDeathIndex = 0x1868; // ParticleIndex_t
		constexpr uint32_t m_iPlayerID = 0x1890; // PlayerID_t
		constexpr uint32_t m_iHeroFacetID = 0x1894; // HeroFacetID_t
		constexpr uint32_t m_hReplicatingOtherHeroModel = 0x1898; // CHandle< C_DOTA_BaseNPC_Hero >
		constexpr uint32_t m_bReincarnating = 0x189c; // bool
		constexpr uint32_t m_bCustomKillEffect = 0x189d; // bool
		constexpr uint32_t m_flSpawnedAt = 0x18a0; // GameTime_t
		constexpr uint32_t m_bScriptDisableRespawns = 0x18a4; // bool
		constexpr uint32_t m_iPrimaryAttribute = 0x18a8; // int32
		constexpr uint32_t m_nLastDrawnHealth = 0x18ac; // int32
		constexpr uint32_t m_flHurtAmount = 0x18b0; // float32
		constexpr uint32_t m_flLastHurtTime = 0x18b4; // GameTime_t
		constexpr uint32_t m_flHurtDecayRate = 0x18b8; // float32
		constexpr uint32_t m_flLastHealTime = 0x18bc; // GameTime_t
		constexpr uint32_t m_flLastTreeShakeTime = 0x18c0; // GameTime_t
		constexpr uint32_t m_CenterOnHeroCooldownTimer = 0x18c8; // CountdownTimer
		constexpr uint32_t m_CombinedModels = 0x1ae8; // CStrongHandle< InfoForResourceTypeCModel >[4]
		constexpr uint32_t m_nCurrentCombinedModelIndex = 0x1b08; // int32
		constexpr uint32_t m_nPendingCombinedModelIndex = 0x1b0c; // int32
		constexpr uint32_t m_iHeroID = 0x1b10; // HeroID_t
		constexpr uint32_t m_flCheckLegacyItemsAt = 0x1b14; // float32
		constexpr uint32_t m_bDisplayAdditionalHeroes = 0x1b18; // bool
		constexpr uint32_t m_CombinedParticleModels = 0x1b28; // CStrongHandle< InfoForResourceTypeCModel >[4]
		constexpr uint32_t m_vecAttachedParticleIndeces = 0x1b48; // CUtlVector< ParticleIndex_t >
		constexpr uint32_t m_hPets = 0x1b60; // CUtlVector< CHandle< C_BaseEntity > >
		constexpr uint32_t m_nKillStreakFX = 0x1b78; // ParticleIndex_t
		constexpr uint32_t m_nKillStreakFXTier = 0x1b7c; // int32
	}
	...
	namespace C_DOTA_BaseNPC {
		...
		constexpr uint32_t m_iTaggedAsVisibleByTeam = 0xc2c; // int32
		constexpr uint32_t m_ModifierManager = 0xc30; // CDOTA_ModifierManager
		constexpr uint32_t m_Inventory = 0xf50; // C_DOTA_UnitInventory
		constexpr uint32_t m_nUnitState64 = 0x1028; // uint64
		constexpr uint32_t m_nUnitDebuffState = 0x1038; // uint64
		constexpr uint32_t m_bHasInventory = 0x1040; // bool
		constexpr uint32_t m_iAcquisitionRange = 0x1044; // int32
		constexpr uint32_t m_FoWViewID = 0x1048; // int32
		constexpr uint32_t m_iPrevHealthPct = 0x104c; // int32
		constexpr uint32_t m_iPrevLifeState = 0x1050; // int32
		constexpr uint32_t m_iPrevTeam = 0x1054; // int32
		constexpr uint32_t m_bPrevProvidesVision = 0x1058; // bool
		constexpr uint32_t m_nPrevControllableMask = 0x1060; // uint64
		constexpr uint32_t m_TagTime = 0x1070; // CountdownTimer
		constexpr uint32_t m_ClickedTime = 0x1088; // CountdownTimer
		constexpr uint32_t m_flIdleRunPoseStartTime = 0x10a0; // GameTime_t[2]
		constexpr uint32_t m_flIdleRunPoseDuration = 0x10a8; // float32[2]
		constexpr uint32_t m_bAnimationTransitionActive = 0x10b0; // bool
		constexpr uint32_t m_nAnimationTransitionPoseParameters = 0x10b4; // int32[2]
		constexpr uint32_t m_nAnimationTransitionInjuredPoseParameters = 0x10bc; // int32[2]
		constexpr uint32_t m_nAnimationTransitionAggressivePoseParameters = 0x10c4; // int32[2]
		constexpr uint32_t m_flTimeSinceLastAbilityNag = 0x1128; // GameTime_t
		constexpr uint32_t m_iAttackCapabilities = 0x112c; // int32
		constexpr uint32_t m_iSpecialAbility = 0x1130; // int32
		constexpr uint32_t m_iMoveCapabilities = 0x1134; // int32
		constexpr uint32_t m_nPlayerOwnerID = 0x1138; // PlayerID_t
		constexpr uint32_t m_flLastDamageTime = 0x113c; // GameTime_t
		constexpr uint32_t m_flLastAttackTime = 0x1140; // GameTime_t
		constexpr uint32_t m_iszMinimapIcon = 0x1148; // CUtlSymbolLarge
		constexpr uint32_t m_flMinimapIconSize = 0x1158; // float32
		constexpr uint32_t m_bMinimapDisableTint = 0x115c; // bool
		constexpr uint32_t m_bMinimapDisableRotation = 0x115d; // bool
		constexpr uint32_t m_colorHeroGlow = 0x115e; // Color
		constexpr uint32_t m_iNearShopMask = 0x1164; // int32
		constexpr uint32_t m_nPoseParameterTurn = 0x1168; // int32
		constexpr uint32_t m_nPoseParameterRun = 0x116c; // int32
		constexpr uint32_t m_flLean = 0x1170; // float32
		constexpr uint32_t m_flRun = 0x1174; // float32
		constexpr uint32_t m_anglediff = 0x1178; // int32
		constexpr uint32_t m_bInfoKeyActive = 0x117c; // bool
		constexpr uint32_t m_bNewUpdateAssetModifiersNetworked = 0x117d; // bool
		constexpr uint32_t m_nAssetModifiersLastUpdatedTick = 0x1180; // GameTick_t
		constexpr uint32_t m_bSuppressGlow = 0x1184; // bool
		constexpr uint32_t m_bWasSinking = 0x1185; // bool
		constexpr uint32_t m_flRangeDisplayDist = 0x1188; // float32
		constexpr uint32_t m_szDefaultIdle = 0x1370; // CUtlSymbolLarge
		constexpr uint32_t m_szDefaultRareIdle = 0x1378; // CUtlSymbolLarge
		constexpr uint32_t m_damagetimer = 0x1380; // CountdownTimer
		constexpr uint32_t m_vRenderOrigin = 0x1398; // Vector
		constexpr uint32_t m_fZDelta = 0x13a4; // float32
		constexpr uint32_t m_flDeathTime = 0x13a8; // GameTime_t
		constexpr uint32_t m_bBaseStatsChanged = 0x13ac; // bool
		constexpr uint32_t m_bNeedsSoundEmitterRefresh = 0x13ad; // bool
		constexpr uint32_t m_flPhysicalArmorValue = 0x13b0; // float32
		constexpr uint32_t m_flMagicalResistanceValue = 0x13b4; // float32
		constexpr uint32_t m_nPrevSequenceParity = 0x13b8; // int32
		constexpr uint32_t m_flPrevInvisLevel = 0x1460; // float32
		constexpr uint32_t m_nOriginalModelIndex = 0x1468; // CStrongHandle< InfoForResourceTypeCModel >
		constexpr uint32_t m_nClientOriginalModelIndex = 0x1470; // CStrongHandle< InfoForResourceTypeCModel >
		constexpr uint32_t m_nClientReplacementModelIndex = 0x1478; // CStrongHandle< InfoForResourceTypeCModel >
		constexpr uint32_t m_bClientReplacementModelNeedsRebuild = 0x1480; // bool
		constexpr uint32_t m_nClientReplacementModelReloadCount = 0x1484; // int32
		constexpr uint32_t m_nUnitModelVariant = 0x1488; // int8
		constexpr uint32_t m_nUnitModelVariantCount = 0x1489; // int8
		constexpr uint32_t m_iPrevSequence = 0x148c; // int32
		constexpr uint32_t m_pLastWeatherEffectName = 0x1490; // char*
		constexpr uint32_t m_VoiceBackgroundSoundTimer = 0x14a0; // CountdownTimer
		constexpr uint32_t m_bIsWaitingToSpawn = 0x14b8; // bool
		constexpr uint32_t m_nTotalDamageTaken = 0x14c0; // int64
		constexpr uint32_t m_flManaRegen = 0x14c8; // float32
		constexpr uint32_t m_flHealthRegen = 0x14cc; // float32
		constexpr uint32_t m_bIsMoving = 0x14d0; // bool
		constexpr uint32_t m_fRevealRadius = 0x14d4; // float32
		constexpr uint32_t m_bCanUseWards = 0x14d8; // bool
		constexpr uint32_t m_bCanUseAllItems = 0x14d9; // bool
		constexpr uint32_t m_iXPBounty = 0x14dc; // int32
		constexpr uint32_t m_iXPBountyExtra = 0x14e0; // int32
		constexpr uint32_t m_iGoldBountyMin = 0x14e4; // int32
		constexpr uint32_t m_iGoldBountyMax = 0x14e8; // int32
		constexpr uint32_t m_hOwnerNPC = 0x14ec; // CHandle< C_BaseEntity >
		constexpr uint32_t m_hGoalEntity = 0x14f0; // CHandle< C_BaseEntity >
		constexpr uint32_t m_hNeutralSpawner = 0x14f4; // CHandle< C_DOTA_NeutralSpawner >
		constexpr uint32_t m_hClientOverrideMaterial = 0x14f8; // CStrongHandle< InfoForResourceTypeIMaterial2 >
		constexpr uint32_t m_bCombinerMaterialOverrideListChanged = 0x1500; // bool
		constexpr uint32_t m_nBaseModelMeshCount = 0x1504; // int32
		constexpr uint32_t m_combinerMaterialOverrideList = 0x1508; // CUtlVector< CStrongHandleCopyable< InfoForResourceTypeIMaterial2 > >
		constexpr uint32_t m_nArcanaLevel = 0x1520; // int8
		constexpr uint32_t m_nDefaultArcanaLevel = 0x1521; // int8
		constexpr uint32_t m_defaultColorGemColor = 0x1522; // Color
		constexpr uint32_t m_bHasBuiltWearableSpawnList = 0x1540; // bool
		constexpr uint32_t m_bHasCostume = 0x1541; // bool
		constexpr uint32_t m_bRecreateParticleSystemsOnModifiersChange = 0x1542; // bool
		constexpr uint32_t m_flAdditionalSinkDelay = 0x155c; // float32
		constexpr uint32_t m_NetworkActivity = 0x1640; // int32
		constexpr uint32_t m_PrevNetworkActivity = 0x1644; // int32
		constexpr uint32_t m_NetworkSequenceIndex = 0x1648; // int32
		constexpr uint32_t m_bShouldDoFlyHeightVisual = 0x164c; // bool
		constexpr uint32_t m_flStartSequenceCycle = 0x1650; // float32
		constexpr uint32_t m_ActivityModifiers = 0x1658; // CUtlVector< CUtlSymbol >
		constexpr uint32_t m_hBackgroundSceneEnt = 0x1670; // CHandle< C_SceneEntity >
		constexpr uint32_t m_hSpeakingSceneEnt = 0x1674; // CHandle< C_SceneEntity >
		constexpr uint32_t m_hOldWearables = 0x1688; // CUtlVector< CHandle< C_EconWearable > >
		constexpr uint32_t m_hOldWearableSkins = 0x16a0; // CUtlVector< CUtlStringToken >
		constexpr uint32_t m_CustomHealthLabel = 0x16b8; // char[256]
		constexpr uint32_t m_CustomHealthLabelColor = 0x17b8; // Color
		constexpr uint32_t m_nWearableDefIndex = 0x17bc; // item_definition_index_t
		constexpr uint32_t m_gibTintColor = 0x17c1; // Color
		constexpr uint32_t m_bForceMaterialCombine = 0x17c5; // bool
		constexpr uint32_t m_bShouldDrawParticlesWhileHidden = 0x17c6; // bool
		constexpr uint32_t m_bIsClientThinkPending = 0x17c7; // bool
		constexpr uint32_t m_bActivityModifiersDirty = 0x17c8; // bool
		constexpr uint32_t m_bUnitModelVariantChanged = 0x17c9; // bool
		constexpr uint32_t m_bWearablesAreTaunting = 0x17ca; // bool
		constexpr uint32_t m_bShowCannotBeDisabledIcon = 0x17e0; // bool
	}
