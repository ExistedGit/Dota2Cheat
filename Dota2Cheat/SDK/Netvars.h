...
namespace Netvars {
	namespace C_DOTA_BaseNPC_Hero {
		...
		constexpr uint32_t m_iCurrentXP = 0x1708; // int32
		constexpr uint32_t m_iAbilityPoints = 0x170c; // int32
		constexpr uint32_t m_flRespawnTime = 0x1710; // GameTime_t
		constexpr uint32_t m_flRespawnTimePenalty = 0x1714; // float32
		constexpr uint32_t m_flStrength = 0x1718; // float32
		constexpr uint32_t m_flAgility = 0x171c; // float32
		constexpr uint32_t m_flIntellect = 0x1720; // float32
		constexpr uint32_t m_flStrengthTotal = 0x1724; // float32
		constexpr uint32_t m_flAgilityTotal = 0x1728; // float32
		constexpr uint32_t m_flIntellectTotal = 0x172c; // float32
		constexpr uint32_t m_flDeathTime = 0x1730; // GameTime_t
		constexpr uint32_t m_iRecentDamage = 0x1734; // int32
		constexpr uint32_t m_fPainFactor = 0x1738; // float32
		constexpr uint32_t m_fTargetPainFactor = 0x173c; // float32
		constexpr uint32_t m_bLifeState = 0x1740; // bool
		constexpr uint32_t m_nFXStunIndex = 0x1744; // ParticleIndex_t
		constexpr uint32_t m_nFXSilenceIndex = 0x1748; // ParticleIndex_t
		constexpr uint32_t m_nFXDeathIndex = 0x174c; // ParticleIndex_t
		constexpr uint32_t m_iPlayerID = 0x1770; // PlayerID_t
		constexpr uint32_t m_hReplicatingOtherHeroModel = 0x1774; // CHandle< C_DOTA_BaseNPC_Hero >
		constexpr uint32_t m_bReincarnating = 0x1778; // bool
		constexpr uint32_t m_bCustomKillEffect = 0x1779; // bool
		constexpr uint32_t m_flSpawnedAt = 0x177c; // GameTime_t
		constexpr uint32_t m_bScriptDisableRespawns = 0x1780; // bool
		constexpr uint32_t m_iPrimaryAttribute = 0x1784; // int32
		constexpr uint32_t m_nLastDrawnHealth = 0x1788; // int32
		constexpr uint32_t m_flHurtAmount = 0x178c; // float32
		constexpr uint32_t m_flLastHurtTime = 0x1790; // GameTime_t
		constexpr uint32_t m_flHurtDecayRate = 0x1794; // float32
		constexpr uint32_t m_flLastHealTime = 0x1798; // GameTime_t
		constexpr uint32_t m_flLastTreeShakeTime = 0x179c; // GameTime_t
		constexpr uint32_t m_CenterOnHeroCooldownTimer = 0x17a0; // CountdownTimer
		constexpr uint32_t m_CombinedModels = 0x19c0; // CStrongHandle< InfoForResourceTypeCModel >[4]
		constexpr uint32_t m_nCurrentCombinedModelIndex = 0x19e0; // int32
		constexpr uint32_t m_nPendingCombinedModelIndex = 0x19e4; // int32
		constexpr uint32_t m_iHeroID = 0x19e8; // int32
		constexpr uint32_t m_flCheckLegacyItemsAt = 0x19ec; // float32
		constexpr uint32_t m_bDisplayAdditionalHeroes = 0x19f0; // bool
		constexpr uint32_t m_CombinedParticleModels = 0x1a00; // CStrongHandle< InfoForResourceTypeCModel >[4]
		constexpr uint32_t m_vecAttachedParticleIndeces = 0x1a20; // CUtlVector< ParticleIndex_t >
		constexpr uint32_t m_hPets = 0x1a38; // CUtlVector< CHandle< C_BaseEntity > >
		constexpr uint32_t m_nKillStreakFX = 0x1a50; // ParticleIndex_t
		constexpr uint32_t m_nKillStreakFXTier = 0x1a54; // int32
	}
	...
	namespace C_DOTA_Item {
		...
		constexpr uint32_t m_iMaxCharges = 0x5d8; // int32
		constexpr uint32_t m_bCombineLocked = 0x5dc; // bool
		constexpr uint32_t m_flPurchaseTime = 0x5e0; // GameTime_t
		constexpr uint32_t m_flAssembledTime = 0x5e4; // GameTime_t
		constexpr uint32_t m_bPurchasedWhileDead = 0x5e8; // bool
		constexpr uint32_t m_bCanBeUsedOutOfInventory = 0x5e9; // bool
		constexpr uint32_t m_bItemEnabled = 0x5ea; // bool
		constexpr uint32_t m_flEnableTime = 0x5ec; // GameTime_t
		constexpr uint32_t m_flReclaimTime = 0x5f0; // GameTime_t
		constexpr uint32_t m_bDisplayOwnership = 0x5f4; // bool
		constexpr uint32_t m_bShowOnMinimap = 0x5f5; // bool
		constexpr uint32_t m_flMinimapIconSize = 0x5f8; // float32
		constexpr uint32_t m_bIsUpgradeable = 0x5fc; // bool
		constexpr uint32_t m_nUpgradeProgress = 0x600; // int32
		constexpr uint32_t m_nUpgradeGoal = 0x604; // int32
		constexpr uint32_t m_hOldOwnerEntity = 0x608; // CHandle< C_BaseEntity >
		constexpr uint32_t m_iOldCharges = 0x60c; // int32
		constexpr uint32_t m_iPlayerOwnerID = 0x610; // PlayerID_t
		constexpr uint32_t m_vecPreGameTransferPlayerIDs = 0x618; // C_NetworkUtlVectorBase< uint8 >
	}
	...
	namespace C_DOTA_Item_PowerTreads {
		constexpr uint32_t m_iStat = 0x638; // int32
	}
	namespace C_DOTA_BaseNPC {
		...
		constexpr uint32_t m_Inventory = 0xe78; // C_DOTA_UnitInventory
		constexpr uint32_t m_nUnitState64 = 0xf30; // uint64
		constexpr uint32_t m_nUnitDebuffState = 0xf40; // uint64
		constexpr uint32_t m_bHasInventory = 0xf48; // bool
		constexpr uint32_t m_iAcquisitionRange = 0xf4c; // int32
		constexpr uint32_t m_FoWViewID = 0xf50; // int32
		constexpr uint32_t m_iPrevHealthPct = 0xf54; // int32
		constexpr uint32_t m_iPrevLifeState = 0xf58; // int32
		constexpr uint32_t m_iPrevTeam = 0xf5c; // int32
		constexpr uint32_t m_bPrevProvidesVision = 0xf60; // bool
		constexpr uint32_t m_nPrevControllableMask = 0xf68; // uint64
		constexpr uint32_t m_TagTime = 0xf78; // CountdownTimer
		constexpr uint32_t m_ClickedTime = 0xf90; // CountdownTimer
		constexpr uint32_t m_flIdleRunPoseStartTime = 0xfa8; // GameTime_t[2]
		constexpr uint32_t m_flIdleRunPoseDuration = 0xfb0; // float32[2]
		constexpr uint32_t m_bAnimationTransitionActive = 0xfb8; // bool
		constexpr uint32_t m_nAnimationTransitionPoseParameters = 0xfbc; // int32[2]
		constexpr uint32_t m_nAnimationTransitionInjuredPoseParameters = 0xfc4; // int32[2]
		constexpr uint32_t m_nAnimationTransitionAggressivePoseParameters = 0xfcc; // int32[2]
		constexpr uint32_t m_flTimeSinceLastAbilityNag = 0x1030; // GameTime_t
		constexpr uint32_t m_iAttackCapabilities = 0x1034; // int32
		constexpr uint32_t m_iSpecialAbility = 0x1038; // int32
		constexpr uint32_t m_iMoveCapabilities = 0x103c; // int32
		constexpr uint32_t m_nPlayerOwnerID = 0x1040; // PlayerID_t
		constexpr uint32_t m_flLastDamageTime = 0x1044; // GameTime_t
		constexpr uint32_t m_flLastAttackTime = 0x1048; // GameTime_t
		constexpr uint32_t m_iszMinimapIcon = 0x1050; // CUtlSymbolLarge
		constexpr uint32_t m_flMinimapIconSize = 0x1060; // float32
		constexpr uint32_t m_bMinimapDisableTint = 0x1064; // bool
		constexpr uint32_t m_bMinimapDisableRotation = 0x1065; // bool
		constexpr uint32_t m_colorHeroGlow = 0x1066; // Color
		constexpr uint32_t m_iNearShopMask = 0x106c; // int32
		constexpr uint32_t m_nPoseParameterTurn = 0x1070; // int32
		constexpr uint32_t m_nPoseParameterRun = 0x1074; // int32
		constexpr uint32_t m_flLean = 0x1078; // float32
		constexpr uint32_t m_flRun = 0x107c; // float32
		constexpr uint32_t m_anglediff = 0x1080; // int32
		constexpr uint32_t m_bInfoKeyActive = 0x1084; // bool
		constexpr uint32_t m_bNewUpdateAssetModifiersNetworked = 0x1085; // bool
		constexpr uint32_t m_nAssetModifiersLastUpdatedTick = 0x1088; // GameTick_t
		constexpr uint32_t m_bSuppressGlow = 0x108c; // bool
		constexpr uint32_t m_bWasSinking = 0x108d; // bool
		constexpr uint32_t m_flRangeDisplayDist = 0x1090; // float32
		constexpr uint32_t m_szDefaultIdle = 0x1250; // CUtlSymbolLarge
		constexpr uint32_t m_szDefaultRareIdle = 0x1258; // CUtlSymbolLarge
		constexpr uint32_t m_damagetimer = 0x1260; // CountdownTimer
		constexpr uint32_t m_vRenderOrigin = 0x1278; // Vector
		constexpr uint32_t m_fZDelta = 0x1284; // float32
		constexpr uint32_t m_flDeathTime = 0x1288; // GameTime_t
		constexpr uint32_t m_bBaseStatsChanged = 0x128c; // bool
		constexpr uint32_t m_bNeedsSoundEmitterRefresh = 0x128d; // bool
		constexpr uint32_t m_flPhysicalArmorValue = 0x1290; // float32
		constexpr uint32_t m_flMagicalResistanceValue = 0x1294; // float32
		constexpr uint32_t m_nPrevSequenceParity = 0x1298; // int32
		constexpr uint32_t m_flPrevInvisLevel = 0x1340; // float32
		constexpr uint32_t m_nOriginalModelIndex = 0x1348; // CStrongHandle< InfoForResourceTypeCModel >
		constexpr uint32_t m_nClientOriginalModelIndex = 0x1350; // CStrongHandle< InfoForResourceTypeCModel >
		constexpr uint32_t m_nClientReplacementModelIndex = 0x1358; // CStrongHandle< InfoForResourceTypeCModel >
		constexpr uint32_t m_bClientReplacementModelNeedsRebuild = 0x1360; // bool
		constexpr uint32_t m_nClientReplacementModelReloadCount = 0x1364; // int32
		constexpr uint32_t m_nUnitModelVariant = 0x1368; // int8
		constexpr uint32_t m_nUnitModelVariantCount = 0x1369; // int8
		constexpr uint32_t m_iPrevSequence = 0x136c; // int32
		constexpr uint32_t m_pLastWeatherEffectName = 0x1370; // char*
		constexpr uint32_t m_VoiceBackgroundSoundTimer = 0x1380; // CountdownTimer
		constexpr uint32_t m_bIsWaitingToSpawn = 0x1398; // bool
		constexpr uint32_t m_nTotalDamageTaken = 0x13a0; // int64
		constexpr uint32_t m_flManaRegen = 0x13a8; // float32
		constexpr uint32_t m_flHealthRegen = 0x13ac; // float32
		constexpr uint32_t m_bIsMoving = 0x13b0; // bool
		constexpr uint32_t m_fRevealRadius = 0x13b4; // float32
		constexpr uint32_t m_bCanUseWards = 0x13b8; // bool
		constexpr uint32_t m_bCanUseAllItems = 0x13b9; // bool
		constexpr uint32_t m_iXPBounty = 0x13bc; // int32
		constexpr uint32_t m_iXPBountyExtra = 0x13c0; // int32
		constexpr uint32_t m_iGoldBountyMin = 0x13c4; // int32
		constexpr uint32_t m_iGoldBountyMax = 0x13c8; // int32
		constexpr uint32_t m_hGoalEntity = 0x13cc; // CHandle< C_BaseEntity >
		constexpr uint32_t m_hNeutralSpawner = 0x13d0; // CHandle< C_DOTA_NeutralSpawner >
		constexpr uint32_t m_hClientOverrideMaterial = 0x13d8; // CStrongHandle< InfoForResourceTypeIMaterial2 >
		constexpr uint32_t m_bCombinerMaterialOverrideListChanged = 0x13e0; // bool
		constexpr uint32_t m_nBaseModelMeshCount = 0x13e4; // int32
		constexpr uint32_t m_combinerMaterialOverrideList = 0x13e8; // CUtlVector< CStrongHandleCopyable< InfoForResourceTypeIMaterial2 > >
		constexpr uint32_t m_nArcanaLevel = 0x1400; // int8
		constexpr uint32_t m_nDefaultArcanaLevel = 0x1401; // int8
		constexpr uint32_t m_defaultColorGemColor = 0x1402; // Color
		constexpr uint32_t m_bHasBuiltWearableSpawnList = 0x1420; // bool
		constexpr uint32_t m_bHasCostume = 0x1421; // bool
		constexpr uint32_t m_NetworkActivity = 0x1540; // int32
		constexpr uint32_t m_PrevNetworkActivity = 0x1544; // int32
		constexpr uint32_t m_NetworkSequenceIndex = 0x1548; // int32
		constexpr uint32_t m_bShouldDoFlyHeightVisual = 0x154c; // bool
		constexpr uint32_t m_flStartSequenceCycle = 0x1550; // float32
		constexpr uint32_t m_ActivityModifiers = 0x1558; // CUtlVector< CUtlSymbol >
		constexpr uint32_t m_hBackgroundSceneEnt = 0x1570; // CHandle< C_SceneEntity >
		constexpr uint32_t m_hSpeakingSceneEnt = 0x1574; // CHandle< C_SceneEntity >
		constexpr uint32_t m_hOldWearables = 0x1588; // CUtlVector< CHandle< C_EconWearable > >
		constexpr uint32_t m_hOldWearableSkins = 0x15a0; // CUtlVector< CUtlStringToken >
		constexpr uint32_t m_CustomHealthLabel = 0x15b8; // char[256]
		constexpr uint32_t m_CustomHealthLabelColor = 0x16b8; // Color
		constexpr uint32_t m_nWearableDefIndex = 0x16bc; // item_definition_index_t
		constexpr uint32_t m_gibTintColor = 0x16c1; // Color
		constexpr uint32_t m_bForceMaterialCombine = 0x16c5; // bool
		constexpr uint32_t m_bShouldDrawParticlesWhileHidden = 0x16c6; // bool
		constexpr uint32_t m_bIsClientThinkPending = 0x16c7; // bool
		constexpr uint32_t m_bActivityModifiersDirty = 0x16c8; // bool
		constexpr uint32_t m_bUnitModelVariantChanged = 0x16c9; // bool
		constexpr uint32_t m_bWearablesAreTaunting = 0x16ca; // bool
		constexpr uint32_t m_bShowCannotBeDisabledIcon = 0x16e0; // bool
	}
	...
	namespace C_DOTA_Item_EmptyBottle {
		constexpr uint32_t m_iStoredRuneType = 0x638; // int32
		constexpr uint32_t m_fStoredRuneTime = 0x63c; // GameTime_t
		constexpr uint32_t rune_expire_time = 0x640; // float32
	}
	...
	namespace CDOTA_Buff {
		...
		constexpr uint32_t m_hScriptScope = 0x1220; // HSCRIPT
	}
}