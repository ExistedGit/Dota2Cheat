...
const uint32_t TableStruct_networkbasetypes_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::CNETMsg_Tick, _impl_.jitter_),
  1,
  2,
  3,
  4,
...
const ::_pbi::DescriptorTable descriptor_table_networkbasetypes_2eproto = {
    false, false, 4246, descriptor_table_protodef_networkbasetypes_2eproto,
...
CNETMsg_Tick::CNETMsg_Tick(const CNETMsg_Tick& from)
  ...
  ::memcpy(&_impl_.tick_, &from._impl_.tick_,
    ...
    reinterpret_cast<char*>(&_impl_.tick_)) + sizeof(_impl_.jitter_));
...
// @@protoc_insertion_point(message_clear_start:CNETMsg_Tick)
  ...
  if (cached_has_bits & 0x00000f00u) {
    ::memset(&_impl_.host_unfiltered_frametime_, 0, static_cast<size_t>(
        ...
        reinterpret_cast<char*>(&_impl_.host_unfiltered_frametime_)) + sizeof(_impl_.jitter_));
  }
  _impl_._has_bits_.Clear();
  _internal_metadata_.Clear<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>();
}
    ...
    switch (tag >> 3) {
      ...
      case 12:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 96)) {
          ...
          _impl_.jitter_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* CNETMsg_Tick::_InternalSerialize(
  ...
  if (cached_has_bits & 0x00000800u) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteUInt32ToArray(12, this->_internal_jitter(), target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:CNETMsg_Tick)
  ...
  if (cached_has_bits & 0x00000f00u) {
    ...
    // optional uint32 jitter = 12;
    if (cached_has_bits & 0x00000800u) {
      total_size += ::_pbi::WireFormatLite::UInt32SizePlusOne(this->_internal_jitter());
    }
...
void CNETMsg_Tick::InternalSwap(CNETMsg_Tick* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(CNETMsg_Tick, _impl_.jitter_)
      + sizeof(CNETMsg_Tick::_impl_.jitter_)
      - PROTOBUF_FIELD_OFFSET(CNETMsg_Tick, _impl_.tick_)>(
